...
const UpdateCategory = () => {
    ...
    const getApiData = async () => {
        try {
            let res = await axios.get("https://vvisionserver.onrender.com/api/category/" + _id)
            console.log(res);
    ...
    const postData = async (e) => {
        ...
        try {
            let res = await axios.put("https://vvisionserver.onrender.com/api/category/" + _id, formData)
            if (res.status === 200) {
