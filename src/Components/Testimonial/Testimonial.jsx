...
const Testimonial = () => {
    ...
    const deleteRecord = async (_id) => {
        try {
            const res = await axios.delete(`http://localhost:8000/api/category/api/testimonial/${_id}`);
            if (res.status === 200) {
    ...
    const getApiData = async () => {
        try {
            const res = await axios.get("http://localhost:8000/api/category/api/testimonial");
