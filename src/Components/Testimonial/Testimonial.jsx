...
const Testimonial = () => {
    ...
    const deleteRecord = async (_id) => {
        try {
            const res = await axios.delete(`https://sanjivanser.onrender.com/api/testimonial/${_id}`);
            if (res.status === 200) {
    ...
    const getApiData = async () => {
        try {
            const res = await axios.get("https://sanjivanser.onrender.com/api/testimonial");
